      ...
      <div className="container">
        ...
        <div className="about-card">
          <p className="description">
            ...
            <span className="name">Temurmalik</span>. Men 16
            yoshdaman va 2 yildan buyon dasturlash sohasida o‘zimni
            rivojlantirib kelmoqdaman. Web texnologiyalar orqali real
            muammolarga yechim topishni yaxshi ko‘raman.
          </p>
